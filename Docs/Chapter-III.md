...
| US27           | Sección sobre nosotros de FoodOs                | Como visitante, quiero que el landing page me muestre una sección sobre los desarrolladores del producto para mantenerme informado.| **Escenario 1:** Usuario quiere saber más del equipo                      | 6    |
| US28           | Sección de contacto de FoodOs                   | Como visitante, quiero que el landing page me muestre una sección que me ponga en contacto con la startup para mantenerme informado.| **Escenario 1:** Usuario llena el formulario para contactar con el startup| 6    |
